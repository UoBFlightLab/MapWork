...
<qgis version="2.8.6-Wien" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/PositionX" value="1~~1~~0.5*(xat(0)+xat(1))~~"/>
    <property key="labeling/dataDefined/PositionY" value="1~~1~~0.5*(yat(0)+yat(1))~~"/>
    <property key="labeling/dataDefined/Rotation" value="1~~1~~atan2(yat(1)-yat(0),xat(1)-xat(0))*(180.0/$pi)~~"/>
    <property key="labeling/dataDefined/Vali" value="1~~1~~'Center'~~"/>
    ...
    <property key="labeling/fieldName" value="round(if(atan2(xat(1)-xat(0),yat(1)-yat(0))&lt;0,360,0)+atan2(xat(1)-xat(0),yat(1)-yat(0))*(180.0/$pi),0) || '°'||round($length,1)||'m'"/>
    ...
    <property key="labeling/placementFlags" value="8"/>
